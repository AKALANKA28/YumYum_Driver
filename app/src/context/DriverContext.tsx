...
import { Alert, AppState, AppStateStatus, Animated, Easing, Dimensions } from 'react-native';
...
export const DriverContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  // State
